...
def parse_arguments():
    ...
    parser.add_argument('--data_url', default="", help='Location of data.')
    ...
    parser.add_argument('--cooldown_length', type=int, default=10, metavar='N',
    ...
    parser.add_argument("--config", help="Config file to use (see configs dir)", default="/cache/user-job-dir/code/src/configs/small_cswin_224.yaml")
    ...
    parser.add_argument('--train_url', default="/cache/user-job-dir/code/train_log/",  help='Location of training outputs.')
